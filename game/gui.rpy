...
define gui.text_color = gui.preference("text_color", u'#e6e6e6') #u'#ffffff' # NIEMA made default text color grey instead of white
...
define gui.text_size = 56 # 66 # NIEMA made smaller
